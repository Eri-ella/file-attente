...
<body>
    ...
    <main class="flex w-full">
        ...
        <form class="flex flex-col items-start justify-center w-1/2 min-h-screen gap-2 text-(--primary-color) px-35" action="{{ route('manager.password.update') }}" method="POST">
            @csrf
