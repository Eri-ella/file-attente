    ...
    <main class="text-(--primary-color) p-10">
        <section>
            ...
            <ol class="flex flex-col list-decimal gap-5 ml-5">
                ...
                <p>Pas besoin de perdre du temps à créer un compte ou de retenir un mot de passe. Cliquez sur « Prendre un ticket », renseignez simplement votre adresse e-mail, puis laissez-vous guider.</p>
        ...
        {{-- ✅ SECTION CONTACTS : ancre pour y arriver directement --}}
        <section id="contacts">
