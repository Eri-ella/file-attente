...
@section('connexion-content')
    ...
    <main class="flex w-full">
        ...
        <form class="flex flex-col items-start justify-center w-1/2 min-h-screen gap-2 px-10 text-(--primary-color)" action="{{ route('passe.send') }}" method="POST">
            @csrf
            ...
            <div class="flex flex-col gap-3 w-full"> 
                ...
                <input class="border-1 border-w-full p-2 rounded-tl-lg rounded-br-lg bg-(--white-color)" type="email" name="email" placeholder="jeandev@gmail.com" value="{{ old('email') }}">
            </div>
            ...
            <div class="flex flex-col w-full gap-5 mt-5 items-center justify-center">
                <input class="btn-primary" type="submit" value="Recevoir le lien">
