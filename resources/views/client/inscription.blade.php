    ...
    <main class="flex w-full">
        ...
        <form class="flex flex-col items-start justify-center w-1/2 min-h-screen gap-2 px-10 text-(--primary-color)" action="{{ route('inscription.store') }}" method="POST">
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <input class="border-1 border-w-full p-2 rounded-tl-lg rounded-br-lg bg-(--white-color)" type="text" name="nom" id="" placeholder="Jean Houessou" required value="{{ old('nom') }}"> 
